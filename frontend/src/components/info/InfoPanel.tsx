    ...
    <>
      <div
        className={`pointer-events-none absolute inset-0 z-30 flex ${
          isMobile ? 'items-start justify-center px-4 py-4' : 'items-center justify-start pl-[50px] pr-4 sm:pr-6 lg:pr-12'
        }`}
      >
        <div className={`pointer-events-auto flex w-full ${isMobile ? 'flex-col' : 'items-center'}`}>
          ...
          {isMobile && (
            <div className="flex w-full items-center justify-between pb-2">
              <button
                ...
                className="rounded-full bg-white/80 p-2 shadow-lg transition hover:scale-105 hover:bg-white"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-6 w-6 text-slate-800">
          ...
          <div
            className={`relative z-20 flex ${
              isMobile ? 'w-full justify-end gap-3 pb-2' : 'flex-col gap-4 py-8'
            }`}
          >
